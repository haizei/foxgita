...
> 日期：2026-09-04  
> 状态：实现已合入 `feat/project-init-simplified`；§10 已按代码走查勾选。交互式模拟器 smoke 未跑。计划见 [2026-09-04-project-init-simplified.md](../plans/2026-09-04-project-init-simplified.md)  
...
- [x] 项目名称是创建 / 编辑唯一必填项
- [x] 完成标准默认折叠，可在详情后补
- [x] 创建 / 编辑页没有类型、阶段、当前重点、封面
- [x] 创建成功直接进详情，没有 Ready 页
- [x] 项目页创建不生成练习项、时长或打卡
- [x] 无练习详情主按钮为「开始第一次练习」
- [x] 完成页和练习详情都能从该练习建项目
- [x] 创建并加入不复制、不改写练习事实
...
上表按 Tasks 1–9 代码路径勾选。本环境无法交互驱动 iOS 模拟器 UI，计划 Task 10 的 8 步 smoke 未在真机/模拟器上跑。
