...
enum GitaSchemaV12: VersionedSchema {
    ...
    final class PracticeSession {
        ...
        var noteText: String
        var profileId: String = ""
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV12.RecordingRef.session)
        var recordings: [GitaSchemaV12.RecordingRef]
        ...
        init(
            ...
            steps: [String],
            noteText: String = "",
            recordings: [GitaSchemaV12.RecordingRef] = [],
            profileId: String = "",
            now: Date = Date()
        ) {
            self.id = id
    ...
    final class RecordingRef {
        ...
        var practiceItem: GitaSchemaV12.PracticeItem? = nil
    ...
    final class PracticeItem {
        ...
        var updatedAt: Date
        var deletedAt: Date?
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV12.RecordingRef.practiceItem)
        var recordings: [GitaSchemaV12.RecordingRef]
