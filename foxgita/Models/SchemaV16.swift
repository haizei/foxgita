...
enum GitaSchemaV16: VersionedSchema {
    ...
    final class PracticeSession {
        ...
        var noteText: String
        var profileId: String = ""
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV16.RecordingRef.session)
        var recordings: [GitaSchemaV16.RecordingRef]
        ...
        init(
            ...
            steps: [String],
            noteText: String = "",
            recordings: [GitaSchemaV16.RecordingRef] = [],
            profileId: String = "",
            now: Date = Date()
        ) {
            self.id = id
    ...
    final class RecordingRef {
        ...
        var practiceItem: GitaSchemaV16.PracticeItem? = nil
    ...
    final class PracticeItem {
        ...
        var updatedAt: Date
        var deletedAt: Date?
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV16.RecordingRef.practiceItem)
        var recordings: [GitaSchemaV16.RecordingRef]
