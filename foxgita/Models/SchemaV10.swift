...
enum GitaSchemaV10: VersionedSchema {
    ...
    final class PracticeSession {
        ...
        var noteText: String
        var profileId: String = ""
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV10.RecordingRef.session)
        var recordings: [GitaSchemaV10.RecordingRef]
        ...
        init(
            ...
            steps: [String],
            noteText: String = "",
            recordings: [GitaSchemaV10.RecordingRef] = [],
            profileId: String = "",
            now: Date = Date()
        ) {
            self.id = id
    ...
    final class RecordingRef {
        ...
        var practiceItem: GitaSchemaV10.PracticeItem? = nil
    ...
    final class PracticeItem {
        ...
        var updatedAt: Date
        var deletedAt: Date?
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV10.RecordingRef.practiceItem)
        var recordings: [GitaSchemaV10.RecordingRef]
