...
enum GitaSchemaV15: VersionedSchema {
    ...
    final class PracticeSession {
        ...
        var noteText: String
        var profileId: String = ""
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV15.RecordingRef.session)
        var recordings: [GitaSchemaV15.RecordingRef]
        ...
        init(
            ...
            steps: [String],
            noteText: String = "",
            recordings: [GitaSchemaV15.RecordingRef] = [],
            profileId: String = "",
            now: Date = Date()
        ) {
            self.id = id
    ...
    final class RecordingRef {
        ...
        var practiceItem: GitaSchemaV15.PracticeItem? = nil
    ...
    final class PracticeItem {
        ...
        var updatedAt: Date
        var deletedAt: Date?
        @Relationship(deleteRule: .cascade, inverse: \GitaSchemaV15.RecordingRef.practiceItem)
        var recordings: [GitaSchemaV15.RecordingRef]
